            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3 bg-white/5 border border-white/10 rounded-lg text-sm text-white focus:outline-none focus:border-[#FA3633]/50"
                />
              </div>
              <div>
                <label className="block text-sm text-white/60 mb-1.5">
                ...
                <select
                  ...
                  className="w-full h-10 px-3 bg-white/5 border border-white/10 rounded-lg text-sm text-white focus:outline-none"
                >
        ...
        {activeTab === "notifications" && (
          <div className="space-y-4">
            {[
              ...
              <label
                key={item.label}
                className="flex items-center justify-between p-4 rounded-lg border border-white/5 hover:border-white/10 transition-colors cursor-pointer"
              >
                <div>
        ...
        {activeTab === "preferences" && (
          <div className="space-y-4">
            <div>
              ...
              <select className="w-full h-10 px-3 bg-white/5 border border-white/10 rounded-lg text-sm text-white focus:outline-none">
