...
export default function SettingsClient({ profile }: { profile: Profile }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs */}
      <div className="flex gap-1 bg-[#111111] border border-white/[0.03] rounded-lg p-1 w-fit">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          return (
            <button
      ...
      {/* Content */}
      <div className="bg-[#111111] border border-white/[0.03] rounded-xl p-6">
        {activeTab === "profile" && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3 bg-white/[0.03] border border-white/[0.05] rounded-lg text-sm text-white focus:outline-none focus:border-[#FA3633]/50"
                />
              </div>
              <div>
                <label className="block text-sm text-white/60 mb-1.5">
                ...
                <select
                  ...
                  className="w-full h-10 px-3 bg-white/[0.03] border border-white/[0.05] rounded-lg text-sm text-white focus:outline-none"
                >
        ...
        {activeTab === "notifications" && (
          <div className="space-y-4">
            {[
              ...
              <label
                key={item.label}
                className="flex items-center justify-between p-4 rounded-lg border border-white/[0.03] hover:border-white/[0.06] transition-colors cursor-pointer"
              >
                <div>
        ...
        {activeTab === "preferences" && (
          <div className="space-y-4">
            <div>
              ...
              <select className="w-full h-10 px-3 bg-white/[0.03] border border-white/[0.05] rounded-lg text-sm text-white focus:outline-none">
