...
export default function DashboardClient({ data }: { data: DashboardData }) {
  ...
  const card = isDark ? "bg-[#1a1a1a] border-[rgba(255,255,255,0.06)]" : "bg-white border-gray-200 shadow-sm";
        ...
        {stats.map((s, i) => (
          <div key={i} className={`${card} border rounded-xl p-5`}>
            <div className="flex items-center justify-between mb-3">
              <span className={`text-2xl p-2 rounded-lg ${isDark ? "bg-[rgba(255,255,255,0.03)]" : "bg-gray-100"}`}>{s.icon}</span>
